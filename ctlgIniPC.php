...
<body>
<h1 class="title"><center>CATÁLOGO DE ACCESORIOS PARA COMPUTADORAS</center></h1>
<?php
	require 'conexion.php';
    $result = mysqli_query($conexion, "SELECT id,producto, precio, descripcion, imagen, imagen_child, Tipo_Producto, stock FROM productos WHERE Tipo_Producto= 'Computadoras' AND stock>0 AND estatus=1");
	?>
	<div class="cards">
	<?php foreach($result as $row){ ?>	
  		<div>
    		<a href="DetallesPC.php?id=<?php echo $row['id']; ?>" type="submit" class="card">
