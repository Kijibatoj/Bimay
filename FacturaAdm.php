...
$facId= $_GET['id'];
 $cs= mysqli_query($conexion, "SELECT Cedula_Rif FROM factura WHERE id_factura='$facId'");
 foreach($cs as $filoso){
     $cedFac = $filoso['Cedula_Rif'];
 }
$result = mysqli_query($conexion, "SELECT * FROM usuarios WHERE Cedula_Rif='$cedFac'");
		...
		<div id="app" class="col-11">
			...
			<div class="row fact-info mt-3">
			  ...
			  <div class="col-3">
				  ...
				  $app = "SELECT usuarios.Cedula_Rif, factura.id_factura, factura.dia_fecha, factura.mes_fecha, factura.ano_fecha FROM usuarios JOIN factura ON usuarios.Cedula_Rif = factura.Cedula_Rif WHERE factura.id_factura= '$facId'  ";
			...
			<div class="row my-5">
			  <table class="table table-borderless factura">
				...
				AND factura.id_factura = factura_producto.id_factura WHERE factura.estatus='0' AND factura.Cedula_Rif = '$cedFac'";
				$result = $conn->query($app);
